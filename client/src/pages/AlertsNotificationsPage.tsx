...
import { Save, Check, Copy, X, Info } from "lucide-react";
...
// ── Pure Display Chat Bubble Component (Non-editable) ──────────────────
interface ChatBubbleProps {
  value: string;
}

function ChatBubble({ value }: ChatBubbleProps) {
  return (
    <div className="alerts-chat-bubble-wrapper">
      <div className="alerts-chat-bubble">{value}</div>
    </div>
  );
}
...
export default function AlertsNotificationsPage() {
  ...
  const [autoReplyNewLeadMessage] = useState(
  ...
  const [autoReplyNewCustomerMessage] = useState(
  ...
  const [teamNotifyNewLeadMessage] = useState(
    "New Lead Received:\nName: {{name}}\nPhone: {{phone}}\nEmail: {{email}}\nCity: {{address}}\nDogs: {{dogs}}\nFrequency: {{frequency}}\nGive them a call!"
  );

  const [teamNotifyNewCustomerEnabled, setTeamNotifyNewCustomerEnabled] = useState(true);
  const [teamNotifyNewCustomerMessage] = useState(
  ...
  const [failedPaymentNotifyMessage] = useState(
  ...
  const [skippedJobNotifyMessage] = useState(
  ...
  const [subscriptionPausedNotifyMessage] = useState(
        ...
        <div className="alerts-card-box">
          <div className="alerts-grid-2">
            ...
            <div className="alerts-item-block">
              ...
              <ChatBubble value={autoReplyNewLeadMessage} />
              <div>
                <ToggleSwitch
            ...
            <div className="alerts-item-block">
              ...
              <ChatBubble value={autoReplyNewCustomerMessage} />
              <div>
                <ToggleSwitch
      ...
      <section className="alerts-section">
        ...
        <div className="alerts-card-box">
          <div className="alerts-grid-2">
            ...
            <div className="alerts-item-block">
              <h3 className="alerts-item-title">Custom New Leads Message</h3>
              <ChatBubble value={teamNotifyNewLeadMessage} />
              <div>
                <ToggleSwitch
                  id="toggle-team-lead"
            ...
            <div className="alerts-item-block">
              <h3 className="alerts-item-title">Custom New Customer Message</h3>
              <ChatBubble value={teamNotifyNewCustomerMessage} />
              <div>
                <ToggleSwitch
              ...
              <div className="alerts-item-block">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div className="flex-1 w-full">
                    <ChatBubble value={failedPaymentNotifyMessage} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="alerts-card-box">
              <div className="alerts-item-block">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div className="flex-1 w-full">
                    <ChatBubble value={skippedJobNotifyMessage} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="alerts-card-box">
              <div className="alerts-item-block">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div className="flex-1 w-full">
                    <ChatBubble value={subscriptionPausedNotifyMessage} />
                  </div>
                </div>
              </div>
            </div>
